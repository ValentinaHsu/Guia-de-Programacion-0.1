...
//del total aportó cada una (indicando nombre y porcentaje) y cuál es el monto del 
...
public class Guia1_ej09 : MonoBehaviour
{
    public string nombre1, nombre2, nombre3;
    public int capital1, capital2, capital3; 
